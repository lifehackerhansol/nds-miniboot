...
#define REG_MCSCR0 (*(volatile uint32_t*)0x040001B0)
#define REG_MCSCR1 (*(volatile uint32_t*)0x040001B4)
#define REG_MCSCR2 (*(volatile uint32_t*)0x040001B8)
...
extern "C"
{
    ...
    static inline void card_romSetCmd(uint64_t cmd)
    {
    ...
    static inline uint32_t card_romGetData(void)
    {
        return REG_MCD1;
    }

    static inline void card_romSetData(uint32_t data)
    {
        REG_MCD1 = data;
    }
    ...
    static inline void card_romStartXfer(uint32_t settings, bool irq)
    {
    ...
    void card_romCpuRead(uint32_t* dst, uint32_t len);
