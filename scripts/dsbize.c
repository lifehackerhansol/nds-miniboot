/*
    ...
    SPDX-FileContributor: Taiju Yamada, 2010
    SPDX-FileNotice: Extracted from xenobox project as a standalone application
...
static int make(const char* path, const int key) {
    ...
    for (; i < 0x200; i++) dsbhead[i] = dsbhead[i] ^ key;
...
int main(const int argc, const char** argv) {
    ...
    key = argv[2] ? strtol(argv[2], NULL, 0) : 0;
